...
class Boiler:
    ...
    def toJson(self):
        ...
        j += "{'name': 'page_index', 'unit': '', 'value:" + \
            self.getPageIndex() + "},"
        j += "{'name': 'flow_switch', 'unit': '', 'value:" + \
            self.getFlowSwitch() + "},"
        j += "{'name': 'pump', 'unit': '', 'value:" + \
            self.getPumpState() + "},"
        j += "{'name': 'speed_fan_1', 'unit': 'rpm', 'value:" + \
            self.getSpeedFan1() + "},"
        j += "{'name': 'speed_fan_2', 'unit': 'rpm', 'value:" + \
            self.getSpeedFan2() + "},"
        j += "{'name': 'speed_fan_3', 'unit': 'rpm', 'value:" + \
            self.getSpeedFan3() + "},"
        j += "{'name': 'puffer', 'unit': '', 'value:" + \
            self.getPuffer() + "},"
        j += "{'name': 'set_puffer', 'unit': '', 'value:" + \
            self.getSetPuffer() + "},"
        j += "{'name': 'set_max_puffer', 'unit': '', 'value:" + \
            self.getSetMaxPuffer() + "},"
        j += "{'name': 'set_min_puffer', 'unit': '', 'value:" + \
            self.getSetMinPuffer() + "},"
        j += "{'name': 'boiler', 'unit': '', 'value:" + \
            self.getBoiler() + "},"
        j += "{'name': 'set_boiler', 'unit': '', 'value:" + \
            self.getSetBoiler() + "},"
        j += "{'name': 'set_max_boiler', 'unit': '', 'value:" + \
            self.getSetMaxBoiler() + "},"
        j += "{'name': 'set_min_boiler', 'unit': '', 'value:" + \
            self.getSetMinBoiler() + "},"
        j += "{'name': 'dhw', 'unit': '', 'value:" + \
            self.getDHW() + "},"
        j += "{'name': 'set_dhw', 'unit': '', 'value:" + \
            self.getSetDHW() + "},"
        j += "{'name': 'set_max_dhw', 'unit': '', 'value:" + \
            self.getSetMaxDHW() + "},"
        j += "{'name': 'set_min_dhw', 'unit': '', 'value:" + \
            self.getSetMinDHW() + "},"
        j += "{'name': 'temperature_room', 'unit': '°C', 'value:" + \
            self.getTemperatureRoom() + "},"
        j += "{'name': 'set_temperature_room', 'unit': '°C', 'value:" + \
            self.getSetTemperatureRoom() + "},"
        j += "{'name': 'set_max_temperature_room', 'unit': '°C', 'value:" + \
            self.getSetMaxTemperatureRoom() + "},"
        j += "{'name': 'set_min_temperature_room', 'unit': '°C', 'value:" + \
