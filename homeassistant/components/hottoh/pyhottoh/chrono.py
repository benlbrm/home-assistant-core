...
class Chrono:
    ...
    def toJson(self):
        ...
        j += "{'name': 'state', 'unit': '', 'value:" + \
            self._getState() + "},"
        j += "{'name': 'set_temperature_1', 'unit': '°C', 'value:" + \
            self._getSetTemperature1() + "},"
        j += "{'name': 'set_max_temperature_1', 'unit': '°C', 'value:" + \
            self._getSetMaxTemperature1() + "},"
        j += "{'name': 'set_min_temperature_1', 'unit': '°C', 'value:" + \
            self._getSetMinTemperature1() + "},"
        j += "{'name': 'set_temperature_2', 'unit': '°C', 'value:" + \
            self._getSetTemperature2() + "},"
        j += "{'name': 'set_max_temperature_2', 'unit': '°C', 'value:" + \
            self._getSetMaxTemperature2() + "},"
        j += "{'name': 'set_min_temperature_2', 'unit': '°C', 'value:" + \
